...
2000 constant IAQ:GAS_SEND
  50 constant IAQ:TEMP_SEND
\ true variable IAQ:DEBUG
false variable IAQ:DEBUG
: DEBUG IAQ:DEBUG @ ;
...
: iaq-send-update?  ( g h p t tadc iaq iaq2 -- g h p t tadc iaq iaq2 ? )
  ...
  ( gas )  iaq.prev_gas @ -  abs IAQ:GAS_SEND > swap
  ( temp ) iaq.prev_temp @ - abs IAQ:TEMP_SEND >
